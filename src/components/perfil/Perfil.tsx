            ...
            <div className="w-full min-h-screen bg-gray-100 px-8 py-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
                    <div className="bg-white p-9 rounded-xl shadow-md">
                        <img src={imagem1} alt="Imagem 1" className="w-36 h-36 mb-4 mx-auto block" />
                        <h3 className="text-lg font-bold mb-3 text-center">Melhore suas vendas</h3>
                    ...
                    <div className="bg-white p-9 rounded-xl shadow-md">
                        <img src={imagem2} alt="Imagem 2" className="w-36 h-36 mb-4 mx-auto block" />
                        <h3 className="text-lg font-bold mb-3 text-center">Campanhas inteligentes</h3>
                        <ul className="list-disc list-inside text-sm space-y-1">
                            ...
                            <li>Avaliação premiada: incentivo para novas reviews com fotos</li>
                        </ul>
                    </div>

                    <div className="bg-white p-9 rounded-xl shadow-md">
                        <img src={imagem3} alt="Imagem 3" className="w-36 h-36 mb-4 mx-auto block" />
                        <h3 className="text-lg font-bold mb-3 text-center">Use o CRM ao seu favor</h3>
                        <ul className="list-disc list-inside text-sm space-y-1">
                            <li>Programe mensagens automáticas e respostas rápidas</li>
                            <li>Use filtros para identificar clientes inativos ou fiéis</li>
                            <li>Crie campanhas segmentadas com base no histórico de compra</li>
